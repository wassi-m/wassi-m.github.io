...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body onload="message()">
        ...
        <?php if (!isset($_SESSION['loggedin'])) {
                echo "<div id='plslogin'>Please <a href='login.php'><strong>Log in</strong></a> to request a Lyric Video</div>";
            }
            else {
        ?>
        ...
        <form onsubmit="return validaterequest()" action="upload.php" method="POST" class="requestform" id="requestform" enctype="multipart/form-data">
            <label for="email">E-mail</label> &nbsp;&nbsp;&nbsp;&nbsp;
            <input type="email" name=email id=email class="input" onblur="checkemail()"><div id="emailerror" class="error"></div><div class="divider3"></div>
            <label for="song">Song Title</label>&nbsp;&nbsp;&nbsp;&nbsp;
            <input type="text" name=song id=song class="input" onblur="checktitle()"><div id="titleerror" class="error"></div><div class="divider3"></div>
            <label for="artist">Artist Name</label>&nbsp;&nbsp;&nbsp;&nbsp;
            <input type="text" name=artist id=artist class="input" onblur="checkartist()"><div id="artisterror" class="error"></div><div class="divider3"></div>
            <label for="lyrics">Paste lyrics here&nbsp;&nbsp;&nbsp;&nbsp;</label>
            <div id="textarea"><textarea name="lyrics" id="lyrics" form="requestform" onblur="checklyrics()"></textarea><div id="lyricserror" class="error"></div></div><div class="divider3"></div>
            <input type="file" name="songfile" id="songfile" accept="audio/*" class="inputfile" onchange="checkfile()"><div id="fileerror" class="error"></div><br>
            <input type="submit" id="submit" name="submit" class="formbutton" value="Submit">
        </form>
