...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body>
        ...
        <div class="contact">
            <h1>Social Media</h1>
            <a href="https://www.instagram.com/WAlyricVids"><img src="icons/instagram.png" class="icon"></img></a>
            <a href="https://www.instagram.com/LyricVids"><img src="icons/youtube.png" class="icon"></img></a>
        </div>
        <div class="contact">
            <h1>E-Mail</h1>
            <div id="emaildiv"><a href="mailto:wassim.achy@gmail.com"><img src="icons/email.png" class="icon" id="email"></img><span>wassim.achy@gmail.com</span></a></div>
        </div>
